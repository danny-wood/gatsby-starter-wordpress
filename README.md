...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, replace `your-project-name` with the name of your site.

    ```shell
    # create a new Gatsby site using the base starter
    gatsby new your-project-name danny-wood/gatsby-starter-wordpress
    ```
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/danny-wood/gatsby-starter-wordpress)

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/import/project?template=https://github.com/danny-wood/gatsby-starter-wordpress)
